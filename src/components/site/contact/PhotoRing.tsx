...
const DURATION = 50; // seconds to traverse the full ribbon once
  ...
  return (
    <>
      ...
      >
        ...
        {TILES.map((t, i) => {
          // Stagger across STAGGER_SLOTS positions; photos past slot 0 wrap via %
          const rawDelay = (i / STAGGER_SLOTS) * DURATION;
          const delaySec = -(rawDelay % DURATION);
