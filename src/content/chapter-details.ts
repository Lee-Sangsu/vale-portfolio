    ...
    projects: [
      {
        ...
        label: copy("Producto digital"),
        description: copy("De pantallas sueltas a una arquitectura de conexión location first."),
        href: "/work/nomadher-app",
        image: "work/nomadher-app/03 iPhone Mockups.png",
      },
      {
        title: copy("Japan Airlines × NomadHer"),
        label: copy("Campaña"),
        description: copy("Una campaña en Instagram, ManyChat y app como un solo embudo."),
        href: "/work/jal-nomadher",
        image: "work/jal-nomadher/Banner.png",
      },
      {
        title: copy("Contenido y comunidad"),
        label: copy("Liderazgo creativo"),
        description: copy("Series, newsletters y campañas que sostienen la conversación entre versiones."),
      },
      {
        title: copy("She Can Travel Anywhere"),
        label: copy("Festival"),
        description: copy("Concepto, logística y treinta piezas físicas para una experiencia de 300 personas en Seúl."),
      },
    ],
  },
  {
