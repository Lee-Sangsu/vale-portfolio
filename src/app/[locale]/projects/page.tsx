  ...
  const portfolioPile = [
    {
      ...
      hoverClass:
        "delay-[20ms] group-hover:-translate-x-7 group-hover:-translate-y-9 group-hover:scale-[1.06] group-hover:-rotate-[17deg]",
      accent: false,
    },
    {
      ...
      hoverClass:
        "delay-[40ms] group-hover:-translate-x-4 group-hover:-translate-y-12 group-hover:scale-[1.06] group-hover:rotate-[16deg]",
      accent: false,
    },
    {
      ...
      hoverClass:
        "delay-[60ms] group-hover:translate-x-2 group-hover:-translate-y-8 group-hover:scale-[1.06] group-hover:rotate-[4deg]",
      accent: false,
    },
    {
      ...
      hoverClass:
        "delay-[80ms] group-hover:-translate-x-6 group-hover:translate-y-4 group-hover:scale-[1.06] group-hover:-rotate-[6deg]",
      accent: false,
    },
    {
      ...
      hoverClass:
        "delay-[100ms] group-hover:translate-x-4 group-hover:translate-y-5 group-hover:scale-[1.06] group-hover:rotate-[17deg]",
      accent: false,
    },
    {
      src: encodeAsset("pages/projects/hero-photos/IMG_2012.png")!,
      ...
      hoverClass:
        "delay-[120ms] group-hover:translate-x-4 group-hover:-translate-y-10 group-hover:scale-[1.06] group-hover:-rotate-[17deg]",
      accent: false,
    },
    {
      src: encodeAsset("pages/projects/hero-photos/IMG_2567.png")!,
      ...
      hoverClass:
        "delay-[140ms] group-hover:translate-x-8 group-hover:-translate-y-11 group-hover:scale-[1.06] group-hover:rotate-[13deg]",
      accent: false,
    },
    {
      src: undefined,
      ...
      hoverClass:
        "delay-[160ms] group-hover:translate-x-10 group-hover:translate-y-4 group-hover:scale-[1.06] group-hover:-rotate-[16deg]",
      accent: true,
    },
  ];
